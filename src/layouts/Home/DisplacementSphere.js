...
export const DisplacementSphere = props => {
  ...
  useEffect(() => {
    ...
    camera.current = new PerspectiveCamera(60, innerWidth / innerHeight, 0.1, 50);
    ...
    startTransition(() => {
      geometry.current = new SphereBufferGeometry(32, 128, 128, 32);
      sphere.current = new Mesh(geometry.current, material.current);
      sphere.current.position.z = 1;
  ...
  useEffect(() => {
    const dirLight = new DirectionalLight(colorWhite, 0.1);
