          ...
          <Fragment>
            ...
            <header className={styles.text}>
              <h1 className={styles.name} data-visible={visible} id={titleId}>
                <DecoderText text="PON TU NOMBRE AQUI │ Portfolio" delay={500} />

              </h1>
              <h1 className={styles.name} data-visible={visible} id={titleId}>
                <DecoderText text="Bienvenidos a mi Sitio" delay={700} />
              ...
              <div>
                ...
                <h1 className={styles.name2} data-visible={visible} id={titleId}>

                  <DecoderText text="TU SLOGAN AQUI" delay={1000} />
